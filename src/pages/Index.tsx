...
const paintProducts = [
  ...
  { id: "paint-2", name: "Watercolor Paint Set", image: "https://images.unsplash.com/photo-1572372578149-c6b0c10f6697?w=400&h=400&fit=crop", price: "৳ 449", category: "paints", badge: "new" as const },
  { id: "paint-3", name: "Oil Paint Set - Professional", image: "https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?w=400&h=400&fit=crop", price: "৳ 799", category: "paints", badge: "hot" as const },
  { id: "paint-4", name: "Tempera Paint Set", image: "https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?w=400&h=400&fit=crop", price: "৳ 399", category: "paints", badge: "new" as const },
  { id: "paint-5", name: "Gouache Paint Set", image: "https://images.unsplash.com/photo-1561998338-13ad7883b20f?w=400&h=400&fit=crop", price: "৳ 699", category: "paints", badge: "new" as const },
];
...
const brushProducts = [
  ...
  { id: "brush-5", name: "Professional Brush Kit", image: "https://images.unsplash.com/photo-1452860606245-08befc0ff44b?w=400&h=400&fit=crop", price: "৳ 899", category: "brushes", badge: "hot" as const },
];

const canvasProducts = [
  { id: "canvas-1", name: "Canvas Board 12x16 inches", image: "https://images.unsplash.com/photo-1615887142175-e0e9e86209be?w=400&h=400&fit=crop", price: "৳ 199", category: "canvases", badge: "new" as const },
  { id: "canvas-2", name: "Stretched Canvas 18x24", image: "https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?w=400&h=400&fit=crop", price: "৳ 349", category: "canvases", badge: "hot" as const },
  { id: "canvas-3", name: "Canvas Panel Set - 5 Pack", image: "https://images.unsplash.com/photo-1544717302-de2939b7ef71?w=400&h=400&fit=crop", price: "৳ 449", category: "canvases", badge: "new" as const },
  { id: "canvas-4", name: "Large Canvas 24x36", image: "https://images.unsplash.com/photo-1571643308907-e9e4c2f4e5cd?w=400&h=400&fit=crop", price: "৳ 599", category: "canvases", badge: "new" as const },
  { id: "canvas-5", name: "Mini Canvas Set - 10 Pack", image: "https://images.unsplash.com/photo-1502139214982-d0ad755818d8?w=400&h=400&fit=crop", price: "৳ 299", category: "canvases", badge: "new" as const },
];

const paletteProducts = [
  { id: "palette-1", name: "Wooden Palette - Large", image: "https://images.unsplash.com/photo-1572372578149-c6b0c10f6697?w=400&h=400&fit=crop", price: "৳ 249", category: "palettes", badge: "new" as const },
  { id: "palette-2", name: "Plastic Palette Set", image: "https://images.unsplash.com/photo-1494891848038-7bd202a2afeb?w=400&h=400&fit=crop", price: "৳ 149", category: "palettes", badge: "new" as const },
  { id: "palette-3", name: "Glass Palette Premium", image: "https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?w=400&h=400&fit=crop", price: "৳ 399", category: "palettes", badge: "hot" as const },
  { id: "palette-4", name: "Mixing Palette with Wells", image: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=400&h=400&fit=crop", price: "৳ 199", category: "palettes", badge: "new" as const },
  { id: "palette-5", name: "Disposable Palette Pad", image: "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=400&h=400&fit=crop", price: "৳ 179", category: "palettes", badge: "new" as const },
];
